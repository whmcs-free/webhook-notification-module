 ...
 */
class WebHookNotificationModule implements NotificationModuleInterface
{
    ...
    {
        $this->setDisplayName('WebHook Notification Module')
    ...
    public function notificationSettings()
    {
        return [
            'url' => [
                ...
                'Type' => 'text',
                'Description' => 'Define the url of your notification webhook.',
                'Required' => true,
            ],
            'botname' => [
    ...
    public function sendNotification(NotificationInterface $notification, $moduleSettings, $notificationSettings)
    {
        if (!$notificationSettings['url']) {
            ...
            throw new \Exception('No url selected for webhook notification delivery.');
        }

        if (!$notificationSettings['channel']) {
            // Abort the Notification.
            throw new \Exception('No channel selected for webhook notification delivery.');
        }
        ...
        $response = $this->makeRequest($notificationSettings['url'], [], $notificationData);
    ...
    private function makeRequest($url, $headers, $data) {
        ...
        */
        ...
        logModuleCall('webhook_notifications', 'make_request', $data, $response, null);
